...
//=== SEGMENTS ===
#include "Digit.h"
Digit digit0(&display, 2, 32 - 0 - 5 * 1, 5, display.color565(0, 0, nivel));  // units of seconds
Digit digit1(&display, 2, 32 - 1 - 5 * 2, 5, display.color565(0, 0, nivel));  // tens of seconds
Digit digit2(&display, 2, 32 - 2 - 5 * 3, 5, display.color565(nivel, nivel, 0));  // units of minutes
Digit digit3(&display, 2, 32 - 3 - 5 * 4, 5, display.color565(nivel, nivel, 0));  // tens of minutes
Digit digit4(&display, 2, 32 - 4 - 5 * 5, 5, display.color565(nivel, 0, 0));  // units of hours
Digit digit5(&display, 2, 32 - 5 - 5 * 6, 5, display.color565(nivel, 0, 0));  // tens of hours 
Digit digit6(&display, 2, 32 - 5 - 5 * 6, 5, display.color565(0, 0, 0));  // tens of hours invisible
//int changeSpeed = 500;
